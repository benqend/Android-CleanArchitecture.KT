...
/**
 * A scope [com.fernandocejas.android10.sample.presentation.internal.di.PerActivity] component.
 * Injects user specific Fragments.
 */
@PerActivity
@Component(dependencies = arrayOf(ApplicationComponent::class), modules = arrayOf(ActivityModule::class, UserModule::class))

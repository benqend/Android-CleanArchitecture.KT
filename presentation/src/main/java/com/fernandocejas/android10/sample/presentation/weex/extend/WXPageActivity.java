...
import com.fernandocejas.android10.sample.presentation.weex.https.WXHttpManager;
import com.fernandocejas.android10.sample.presentation.weex.https.WXHttpTask;
import com.fernandocejas.android10.sample.presentation.weex.https.WXRequestListener;
import com.fernandocejas.android10.sample.presentation.weex.util.ScreenUtil;
...
/**
 * Created by jiangbenpeng on 7/27/16.
 *
 * @author jiangbenpeng
 * @date 7/27/16
 */
public class WXPageActivity extends Activity implements IWXRenderListener, android.os.Handler.Callback {

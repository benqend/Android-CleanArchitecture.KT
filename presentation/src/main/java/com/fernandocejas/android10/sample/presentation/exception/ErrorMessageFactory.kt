...
class  ErrorMessageFactory {
    ...
    companion object {
        ...
        fun create(context: Context, exception: Exception): String {
            ...
            when (exception) {
                is NetworkConnectionException -> message = context.getString(R.string.exception_message_no_connection)
                is UserNotFoundException -> message = context.getString(R.string.exception_message_user_not_found)
            }

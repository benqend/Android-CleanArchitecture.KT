...
@Inject
constructor(private val userId: Int, private val userRepository: UserRepository,
            threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread) : UseCase(threadExecutor, postExecutionThread) {

    public override fun buildUseCaseObservable(): Observable<Any> {
        return this.userRepository.user(this.userId) as Observable<Any>
    }
}
